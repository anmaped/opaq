...
JsonArray::JsonArray(const char* json, jsmntok_t* tokens)
...
const char* JsonArray::getString(int index, int *init, int *end)
{
    return getStringFromToken(getToken(index),init,end);
}
